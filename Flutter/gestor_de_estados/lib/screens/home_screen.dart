  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          BottomNavigationBarItem(icon: Icon(Icons.home), label: 'Página 1'),
          BottomNavigationBarItem(icon: Icon(Icons.search), label: 'Página 2'),
          BottomNavigationBarItem(icon: Icon(Icons.person), label: 'Página 3'),
        ],
        onTap: (index) {
          setState(() {
            _currentIndex = index;
