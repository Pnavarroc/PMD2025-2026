...
import iesch.org.practica06.databinding.ActivityRegisterHeroeBinding
import iesch.org.practica06.detalle.DetalleHeroeActivity
import iesch.org.practica06.model.SuperHeroe
import java.io.File
import kotlin.jvm.java
import kotlin.text.isNotEmpty

class RegisterSuperActivity : AppCompatActivity() {

    private lateinit var binding: ActivityRegisterHeroeBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityRegisterHeroeBinding.inflate(layoutInflater)
